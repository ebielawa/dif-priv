...
def expose(query_func):
  ...
  # print(many_results[0])

  # print(many_results[0][0])
  ...
  for r in range(0, rows):
    ...
    for i in range(num_iterations):
      # Accumulate average (empirical mean estimation)
      # It would be funny to use robust mean estimation
      value += np.max(many_results[i][r][-1], 0)
